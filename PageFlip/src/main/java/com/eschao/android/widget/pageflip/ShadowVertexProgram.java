...
/**
 * Shadow vertex m_shader program which is used to load:
 * <ul>
...
public class ShadowVertexProgram extends GLProgram {
    ...
    // variable names defined in m_shader scripts
    ...
    /**
     * Get variable handles from linked m_shader program
     */
